...
# and calculate the similarity of those words with what we already got
...
Matrix_list = ['a', 'b', 'c', 'd', 'w', 'x', 'k', 'l', 'e', 'i', 'j', 'm', 'u', 'v', 't', 'h', 'n', 'o', 'g', 'y', 'f',
               'r']
score = 0;
window = Tk()
...
word_check.focus()
btncheck1= Button(window, text="OK", bg="RED", fg="white", width=5, font=('Helvetica', '10'),
                  command=checkspells)
btncheck2= Button(window, text="RESET", bg="RED", fg="white", width=5, font=('Helvetica', '10'),
                  command=checkspells)
btncheck1.place(x=760, y=250)
btncheck2.place(x=860, y=250)
